...
Compiler.prototype = {
  ...
  buffer: function (str, interpolate) {
    ...
    if (this.lastBufferedIdx == this.buf.length) {
      ...
      this.buf[this.lastBufferedIdx - 1] = 'jade_html += ' + this.bufferStartChar + this.lastBuffered + '";'
    } else {
      this.buf.push('jade_html += "' + str + '";');
      this.lastBufferedType = 'text';
  ...
  prettyIndent: function(offset, newline){
    ...
    if (this.parentIndents)
      this.buf.push('jade_html += jade_indent.join("");');
  },
